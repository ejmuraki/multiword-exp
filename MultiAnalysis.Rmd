...
write_excel_csv(master_ratings, file = file.path(path_out, "Expression_Concreteness_Ratings.csv"))
write_excel_csv(master_complete, file = file.path(path_out, "Expression_Concreteness_Ratings_Complete.csv"))
```
